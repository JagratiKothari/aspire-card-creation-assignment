...
export const SideBar: React.FC = () => {
  return (
    <SideBarContainer>
      ...
      <nav>
        <List>
          <Link to="/aspire-card-creation-assignment/home">
            <img src={HomeIcon} alt="home-logo" />
            <div>Home</div>
          </Link>
          <Link to="/aspire-card-creation-assignment/cards">
            <img src={CardIcon} alt="home-logo" />
            <div>Cards</div>
          </Link>
          <Link to="/aspire-card-creation-assignment/payments">
            <img src={PaymentIcon} alt="home-logo" />
            <div>Payments</div>
          </Link>
          <Link to="/aspire-card-creation-assignment/credit">
            <img src={CreditIcon} alt="home-logo" />
            <div>Credit</div>
          </Link>
          <Link to="/aspire-card-creation-assignment/settings">
